    ...
    <View style={styles.card}>
      <View style={styles.content}>
        <View style={styles.info}>
          <Animated.View
            style={[styles.shimmerLine, styles.titleWidth, { opacity }]}
          />
          <Animated.View
            style={[styles.shimmerLine, styles.brandWidth, { opacity }]}
          />

          <View style={styles.priceRow}>
            <Animated.View
              style={[styles.shimmerLine, styles.priceWidth, { opacity }]}
            />
          ...
          <View style={styles.metaRow}>
            ...
            <Animated.View
              style={[styles.shimmerPill, styles.bestPillWidth, { opacity }]}
            />
          </View>
        </View>
